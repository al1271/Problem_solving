...
//using the total amount to find the average
...
var item = "Videogame";
var taxPercent = .1;
var percentConversion = percent / 100;

//price of item with and without tax calculations

var untaxed= original*percentConversion;
var taxed = (untaxed * taxPercent) + untaxed;
console.log(" your " + item + " was originally $" + original + " but after a " + percent + "% discount, it is now $" + untaxed + " without tax, and $" + taxed + " with tax ");