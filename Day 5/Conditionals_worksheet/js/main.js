...
var temperatureType = prompt("Are you converting to celsius or fahrenheit").toLowerCase();
...
var time = prompt("Is it between the times of 3pm and 5pm(Yes or No)").toLowerCase();
var age = prompt("Are you under 10 or over 55? (Yes or No)").toLowerCase();
...
if(time === "yes" && age === "yes"){
    ...
    //if time isn't but age is no discount price
}else if(time === "no" && age === "yes"){
    console.log("Your ticket price is $" + dTicket);
    //if time is but age isn't discount price
}else if(time === "yes" && age === "no"){
        console.log("Your ticket price is $" + dTicket);
        //if neither are true normal price
}else{
